  ...
  >
    ...
    >
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
        ...
        {/* HEADER */}
        <header className="relative shrink-0 overflow-hidden border-b border-white/10 bg-gradient-to-br from-zinc-900 via-zinc-950 to-black px-5 py-6 sm:sticky sm:top-0 sm:z-20 sm:px-8 sm:py-8 lg:px-10">
          ...
          <div className="relative pr-12">
            ...
            <p
              id={descriptionId}
              className="mt-3 max-w-3xl text-lg text-zinc-300 sm:text-xl"
            >
              {formation.subtitle}
            </p>
          </div>
        ...
        {/* BOUTONS */}
        <footer className="shrink-0 border-t border-white/10 bg-zinc-950/95 px-5 py-4 backdrop-blur-xl sm:sticky sm:bottom-0 sm:z-20 sm:px-8 lg:px-10">
